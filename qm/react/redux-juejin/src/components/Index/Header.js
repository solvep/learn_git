      ...
      <header className="main-header visible">
        <div className="container">
          ...
          <div className="nav-menu">
            <Menu defaultActive="1" mode="horizontal">
              ...
              <Menu.Item className="Item" index="6">
                <Input size="small" icon="search" placeholder="搜索"></Input>
              </Menu.Item>
                <Menu.Item index="7">
                ...
                <Menu.Item index="8">
                  ...
                  <Button type="text" className="text" onClick={() =>{this.setState({'registerDialog':true})}}>注册</Button>
                </Menu.Item>
            </Menu>
          </div>
          </div>
          <RegisterDialog visible={this.state.registerDialog}
            ...
            registerActions={this.props.registerActions}></RegisterDialog>
      </header>
    )
  }
}
