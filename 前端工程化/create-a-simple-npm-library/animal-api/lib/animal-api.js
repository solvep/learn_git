...
const getCat = () => {
    // 发送请求
    return axios__WEBPACK_IMPORTED_MODULE_0___default().get('https://aws.random.cat/meow').then((response) => {
...
const getDog = () => {
    return axios__WEBPACK_IMPORTED_MODULE_0___default().get('https://random.dog/woof.json').then((response) => {
